# Spec: Interview Config Reactivity

## Purpose

Ensure the interview preparation page's configuration area (JD selector, CV status indicator) always reflects the latest data from IndexedDB and localStorage without requiring a full page refresh.
