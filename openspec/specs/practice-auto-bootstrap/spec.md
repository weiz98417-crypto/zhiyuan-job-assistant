# Spec: Practice Auto-Bootstrap

## Purpose

Ensure the interview practice panel automatically initiates a coaching session when first opened for a question, providing immediate AI guidance via SSE streaming without manual user input.
