...
export const TOOL_GOVERNANCE_REGISTRY: Record<string, ToolGovernance> = {
  ...
  transfer_to_agent: meta({
    ...
    effect: "read",
    allowedTaskTypes: ["general_chat", "career_positioning_guidance", "resume_query", "resume_edit", "jd_evaluation", "offer_evaluation", "interview_coaching", "profile_update", "job_search"],
    agentAllowlist: ["general", "resume", "evaluate", "interview", "offer", "profile"],
    documentTypes: ["session"],
    requiresUserConfirmation: false,
    requiresReadBack: false,
    successContract: "Hand over responsibility along a legal task-journey edge; the loop swaps the responsible agent.",
    userVisibleNameZh: "主责交接",
  }),
  delegate_research: meta({
    name: "delegate_research",
    effect: "read",
    allowedTaskTypes: ["general_chat", "career_positioning_guidance", "resume_query", "resume_edit", "jd_evaluation", "offer_evaluation", "interview_coaching", "job_search"],
    agentAllowlist: ["general", "resume", "evaluate", "interview", "offer", "profile"],
    documentTypes: ["session"],
    requiresUserConfirmation: false,
    requiresReadBack: false,
    successContract: "Run a read-only inline research subtask and return findings; never writes user data.",
    userVisibleNameZh: "研究委派",
  }),
  search_jobs: meta({
    name: "search_jobs",
    effect: "read",
