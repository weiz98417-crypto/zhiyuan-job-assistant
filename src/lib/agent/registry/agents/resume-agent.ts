...
const RESUME_TOOL_NAMES = ["read_file", "import_resume", "generate_cv", "evaluate_jd", "export_file", "get_reference_detail", "optimize_resume_section", "create_resume_edit_proposal", "apply_resume_edit_proposal", "discard_resume_edit_proposal", "rollback_resume_edit_proposal", "save_resume_section", "save_reference_resume", "check_ats_compatibility"];
