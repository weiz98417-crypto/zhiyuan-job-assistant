...
import { createResumeEditProposal } from "./action/create-resume-edit-proposal";
import { applyResumeEditProposal } from "./action/apply-resume-edit-proposal";
import { discardResumeEditProposal } from "./action/discard-resume-edit-proposal";
import { rollbackResumeEditProposal } from "./action/rollback-resume-edit-proposal";
...
registry.register(createResumeEditProposal);
registry.register(applyResumeEditProposal);
registry.register(discardResumeEditProposal);
registry.register(rollbackResumeEditProposal);
